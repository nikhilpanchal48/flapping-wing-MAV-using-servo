...
static int servo_comm3 = 0;
static int servo_comm4 = 0;
volatile int flapangle1 = 0;
volatile int flapangle2 = 0;
volatile int flapangle3 = 0;
volatile int flapangle4 = 0;
...
flapmag=(pwm_value-880)/41.0+20;
flapdeg=flapmag*sin(theta);//variable amplitude+freq


flapangle1=(int)((30.0-flapdeg+servo_zero1)*2.0+15.0);
flapangle2=(int)((30.0+flapdeg+servo_zero2)*2.0+15.0);
flapangle3=(int)((30.0-flapdeg+servo_zero2)*2.0+15.0);
flapangle4=(int)((30.0+flapdeg+servo_zero2)*2.0+15.0);

if (pwm_value > 1100){
servo_comm1 = flapangle1;
servo_comm2 = flapangle2;
servo_comm3 = flapangle3;
servo_comm4 = flapangle4;
}
...
servo_comm3 = (int)((30.0-glide_deg+servo_zero1)*2.0+25.0);
servo_comm4 = (int)((30.0+glide_deg+servo_zero2)*2.0+25.0);
...
myservo3.write(servo_comm3); // tell servo to go to position in variable 'pos'
myservo4.write(servo_comm4); // tell servo to go to position in variable 'pos'
